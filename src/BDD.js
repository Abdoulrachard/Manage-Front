let actualityDatas = [
  {
    ...
    content:
      "En 2023, nous sommes fiers d'avoir pu proposer des réponses de qualité, sur mesure et concertées aux problématiques très variées qui nous ont été proposées",
  ...
  },
  {
    ...
    content:
      "Polyprime, un nouvel ensemble idéalement situé à Villars-Sainte-Croix, proposera dès le printemps 2027 près de 12'000 m2 de surfaces artisanales et industrielles",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Point de vue sur le projet Malley Phare dans le journal économique de référence Finanz und Wirtschaft',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Dans un bel environnement arboré, cette nouvelle zone d’activités créera environ 230 emplois selon l’organisation suivante : l’Hôtel de l’Innovation (30), immeuble accueillant le Centre suisse de compétences en matière d’exécution des sanctions pénales CSCSP (90) et un pôle médical (110).',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'La rénovation de bâtiment représente un des défis majeurs de la transition énergétique. Dans le contexte actuel, les rénovations énergétiques représentent un important levier d’action pour améliorer l’efficacité énergétique du bâti en Suisse et revaloriser l’existant, tout en respectant le patrimoine bâti.',
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-7.jpg`,
    imageAlt:
      'Revue de presse - Apprentissages en altitude : Carrières diversifiées à la Vallée de Joux',
    categories: 'Revue de presse',
    date: '24.11.2023',
    title: 'Apprentissages en altitude : Carrières diversifiées à la Vallée de Joux',
    content:
      '"Pour CCHE, la transmission du savoir est importante, ainsi, nous mettons un point d’honneur à offrir une formation de qualité." Roland Cabut',
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-8.jpg`,
    imageAlt:
      'Revue de presse - Hôtel Lavaux : le patrimoine architectural régional en valeur dans la NZZ',
    categories: 'Revue de presse',
    date: '21.11.2023',
    title: 'Hôtel Lavaux : le patrimoine architectural régional en valeur dans la NZZ',
    content:
      'Découverte de Lavaux et son patrimoine architectural dans la NZZ, qui s’intéresse notamment à l’Hôtel Lavaux, réalisé par Alberto Sartoris en 1965 et entièrement rénové par CCHE en 2012.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Les stratégies socio-spatiales développées par nos urbanistes accompagnent nos projet de logements pour les adapter au plus près des besoins du marché',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'La méthodologie des megatrends développée par le bureau CCHE traite des grandes mutations actuelles et futures de la société les megatrends ou mégatendances sont des changements économiques sociétaux, technologiques et politiques de grande ampleur qui influencent notre société.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'La co-construction de projet est une méthodologie qui prône la collaboration en impliquant activement les parties prenantes dans le processus de décision, de conception et d’action dans le but d’obtenir un résultat efficient et reconnu par toutes et tous.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "L’identification de profils types d’usagers permet d'établir des scénarios pour illustrer les valeurs d’usage d’un bâtiment ou d’un quartier (lieux de vie et d’échanges, aménagements extérieurs, typologies…).",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    date: '09.11.2023',
    title:
      'Transformation de la nouvelle concession DIMAB à Rossens en un espace harmonieux et fonctionnel.',
    content:
      "Notre mission était claire : créer une signalétique interne et externe qui conserve l'identité visuelle du groupe BMW-MINI Switzerland tout en s'intègrant harmonieusement dans ce bâtiment aux multiples affectations.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Le chantier prévoit 4 phases successives afin de permettre la relocation progressive des locataires des anciens immeubles. Un grand soin a été mis par les propriétaires sur l'accompagnement et la communication avec les locataires afin de minimiser au maximum l'impact du chantier.",
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-20.jpg`,
    imageAlt:
      'Actualités - Le chantier du projet de rénovation de la cité Carl-Vogt à Genève est terminé',
    categories: 'Actualités',
    date: '31.10.2023',
    title: 'Le chantier du projet de rénovation de la cité Carl-Vogt à Genève est terminé',
    content:
      "La rénovation complète par CCHE Et MSV architectes des 5 immeubles formant la cité Carl-Vogt s'est achevée avec succès. Ces bâtiments Honegger datant des années 60 abritent 445 appartements répartis dans cinq bâtiments de huit étages et nécessitaient une rénovation en profondeur, notamment sur le plan énergétique.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    imageAlt:
      "Actualités - Première labélisation SNBS-Quartier de Suisse pour le Quartier de l'Etang à Vernier",
    categories: 'Actualités',
    date: '18.10.2023',
    title: "Première labélisation SNBS-Quartier de Suisse pour le Quartier de l'Etang à Vernier",
    content:
      'La certification SNBS-Quartier vient récompenser les qualités architecturales et urbanistiques du projet ainsi que sa contribution à l’économie régionale ou encore les mesures mises en œuvre pour préserver faune et flore.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "« Notre nouvel espace de travail symbolise la volonté de réunir au coeur de Plainpalais nos collaborateur.trice.s au sein d’un environnement propice à l'innovation et à la collaboration », selon Frédéric Ducrest et Cornélia Volkringer, architectes associés de CCHE Genève SA.",
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-25.jpg`,
    imageAlt:
      'Actualités - Bouquet de chantier du bâtiment B2: nouvelle étape clé pour la Suettaz à Nyon',
    categories: 'Actualités',
    date: '03.10.2023',
    title: 'Bouquet de chantier du bâtiment B2: nouvelle étape clé pour la Suettaz à Nyon',
    content:
      'Le bouquet de chantier marquant la fin du gros-œuvre du bâtiment B2 vient concrétiser le développement du nouveau quartier exemplaire de la Suettaz.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Ce mardi 26 septembre s'est tenu la cérémonie du prix de l'immobilier romand 2023 lancé par le magazine Bilan, en collaboration avec le SVIT Romandie et vise à récompenser les projets immobiliers les plus remarquables réalisés en Suisse romande.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Le début des travaux de rénovation du Centre de congrès et d’expositions de Montreux a été célébré en présence des autorités, mandataires et entreprises au cours d'un bouquet de chantier.",
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-29.jpg`,
    imageAlt:
      "Revue de presse - Permis de construire en force pour l'hôtel et le centre de formation du MIC",
    categories: 'Revue de presse',
    date: '25.09.2023',
    title: "Permis de construire en force pour l'hôtel et le centre de formation du MIC",
    content:
      "Un nouveau centre de formation, comprenant trois bâtiments dont un hôtel, viendra enrichir l'offre du Marly Innovation Center dès 2026.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Unique en Suisse romande avec sa structure en épicéa, l’immeuble «Malley Phare» se composera de 14 étages posés sur un bâtiment existant. Le chantier est une gageure.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "La ville de Lancy a inauguré hier officiellement le tout nouveau groupe scolaire de Pont-Rouge, une réalisation architecturale d'envergure qui ouvre de nouvelles perspectives éducatives.",
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-32.jpg`,
    imageAlt:
      "Communauté - Les Grillades de l'été 2023 : unir nos talents et construire l'avenir ensemble",
    categories: 'Communauté',
    date: '24.08.2023',
    title: "Les Grillades de l'été 2023 : unir nos talents et construire l'avenir ensemble",
    content:
      "L'édition 2023 de la rencontre 'Les Grillades de l'été' réunissait la communauté CCHE pour la visite de la nouvelle école de Pont-Rouge à Lancy, projet développé et réalisé par le bureau, suivie d'une soirée grillades conviviale.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Véritable porte d’entrée du quartier, l'îlot Les Atmosphères entre dans sa phase finale et se profile déjà comme LE lieu de rencontres, de découvertes et d’expériences pour les habitant.e.s, les travailleur.euse.s et les visiteur.euse.s.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    imageAlt:
      'Actualités - La nouvelle école de Pont-Rouge bientôt prête à accueillir ses premiers élèves',
    categories: 'Actualités',
    date: '28.07.2023',
    title: 'La nouvelle école de Pont-Rouge bientôt prête à accueillir ses premiers élèves',
    content:
      'La réalisation de la nouvelle Ecole de Pont-Rouge est à bout touchant et le bâtiment pourra accueillir ses premiers élèves dès la rentrée scolaire 2023.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Le nouveau siège international de Médecins sans Frontières intègre une signalétique signée CCHE Design. Minimaliste, intuitif et flexible, le nouveau système d'orientation a été pensé pour différencier les informations d’orientation « invariables » de celles qui pourraient être « modifiables ».",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Née d’une initiative interne au début d’année 2023, l’équipe de voile CCHE Sailing Team est composée d’une quinzaine de collègues de tous niveaux, confirmés comme débutants, qui naviguent sur un voilier « Grand Surprise », le Silène.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'L’écoquartier de Marly a amorcé sa seconde phase de construction, en lien direct avec la phase initiale achevée en 2022 qui regroupe des logements, activités, loisirs et commerces.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Découvrez 'Les Roseaux' à Grandson, deux bâtiments Minergie sobres et élégants, proposant 19 appartements spacieux de haut standing pieds dans l'eau, au bord du lac de Neuchâtel dans un environnement naturel unique et privilégié.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Une rénovation tout en prouesses techniques. À Genève, le domaine Barton fait l’objet d’une rénovation complète sur deux ans, en vue de réhabiliter les bâtiments. Boiseries classées, séquoias imposants font partie des importantes contraintes du projet.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Alors que le bouquet de chantier vient de célébrer la fin du clos couvert pour la réalisation de ce nouvel immeuble locatif préfabriqué en bois, place maintenant aux aménagements et équipements intérieurs et extérieurs.',
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-45.jpg`,
    imageAlt:
      'Actualités - Timoté Mopty, nommé architecte associé, rejoint la Direction de CCHE Nyon',
    categories: 'Actualités',
    date: '14.06.2023',
    title: 'Timoté Mopty, nommé architecte associé, rejoint la Direction de CCHE Nyon',
    content:
      'CCHE Nyon SA a le plaisir d’annoncer la nomination de Timoté Mopty, issu de ses propres rangs, comme nouvel architecte associé. Il rejoint Stéphanie Suard Dancet et Max Nack à la direction du bureau et affirme la volonté du groupe de se structurer afin de poursuivre son développement par la promotion de ses talents.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "En marge de la mise en place des premiers éléments en bois de la tour Malley Phare à Prilly, Migros Magazine consacre un dossier architecture à l'utilisation de ce matériau écologique dans le cadre des constructions hautes.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Depuis son lancement en 2017, notre filiale genevoise n'a cessé d'évoluer pour mener à bien ses projets d’envergure. C’est donc dans des nouveaux locaux, situés au cœur du quartier des Bains à Plainpalais, que nos collègues poursuivront leur activité dès mi juin.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'CCHE Porto Lda a le plaisir d’annoncer la nomination de Michael Pereira, issu de ses propres rangs, comme nouvel architecte associé. Il rejoint Carolina Azevedo à la direction du bureau et vient renforcer la présence internationale du groupe.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "La dixième édition de Tout un cinéma était l'occasion de réunir l'ensemble des collaborateurs.trices CCHE pour découvrir le travail et les projets de chaque équipe au travers de clips diffusés sur grand écran au cinéma.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Les trois nouveaux bâtiments qui formeront le secteur F du Marly Innovation Center ainsi que le Parc du Coteau ont été présentés à la population dans le cadre d'une séance d'information publique. La Liberté",
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-52.jpg`,
    imageAlt:
      'Actualités - La pose des premiers éléments en bois dans le quartier Isabelle de Montolieu',
    categories: 'Actualités',
    date: '14.03.2023',
    title: 'La pose des premiers éléments en bois dans le quartier Isabelle de Montolieu a débuté',
    content:
      'La pose des premiers éléments en bois dans le quartier Isabelle de Montolieu a débuté',
    link: 'javascript:void(0)'
  },
  {
    image: `/src/assets/image/actualites/a-53.jpg`,
    imageAlt:
      'Actualités - Inauguration des nouveaux aménagements du centre de biométrie à Lausanne',
    categories: 'Actualités',
    date: '21.03.2023',
    title: 'Inauguration des nouveaux aménagements du centre de biométrie à Lausanne',
    content:
      'Les nouveaux locaux du centre de biométrie de Lausanne ont été inaugurés en présence de la Conseillère d’Etat Isabelle Moret',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'CCHE renforce son expertise en obtenant la certification professionnelle BIM délivrée par buildingSMART.',
    link: 'javascript:void(0)'
  },
  {
    ...
    date: '21.02.2023',
    title:
      'Quartier de la Suettaz à Nyon : présentation du chantier par les équipes de Couleurs Locales (RTS - Radio Télévision Suisse Un)',
    content:
      "Interview d'Ilhan Yakut Büchler, Directeur Société coopérative d'habitation Lausanne et LSR SA, et de Stéphanie Suard, Architecte associée CCHE Nyon SA.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Découvrez The Hive, un campus développé autour de l’humain et dédié à l’innovation et la technologie à Meyrin/Satigny.',
    link: 'javascript:void(0)'
  },
  {
    ...
    date: '14.12.2022',
    title:
      "Quartier de l'Etang : livraison des aménagements intérieurs de l'îlot F1 | Les Fabriques Ouest",
  ...
  },
  {
    ...
    content:
      "Découvrez le développement en cours de l'îlot « Les Atmosphères », emblème du quartier de l’Etang à Vernier.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'CCHE s’est implanté au Sentier en 2016, dans l’objectif de participer activement au développement économique et urbanistique de la Vallée de Joux en amenant dans la région les compétences d’un grand bureau au travers d’une structure à taille locale.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Découvrez en détails la transformation et mise aux normes du centre commercial Chablais Centre en cours.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "La nouvelle école Adélaïde Sara Pictet-de-Rochemont propose d'implanter l'école au sein d'un parc d’apprentissage regroupant nature et culture dans un environnement proche et innovant.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Le concours de projets en procédure sélective Freistatt Thun porte sur la planification et la réalisation d'un ensemble résidentiel sur le site de Freistatt 1.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Découvrez l'interview de Daniel Grosso, Architecte associé dans le cahier des entreprises de la revue INSA",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Dans le cadre d’un changement d’occupants, les nouveaux aménagements extérieurs réalisés par nos architectes paysagistes développent trois entités paysagères distinctes: L'Entrée, Les Jardins, Le Patio",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Présentation en mode micro-trottoir des équipes d'apprenti.e.s en cours de formation dans l'une des filiales CCHE.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Après deux super éditions en 2020 et 2021, nos 8 mates ont relevé l'objectif qu'ils s'étaient donné de faire le tour en moins de 19h cette année.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Déposée sur les flancs des combes combières, cette nouvelle prouesse architecturale a ouvert récemment ses portes. Un édifice unique. 24 Heures',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'CCHE Genève était associé aux architectes français Carta - Reichen et Robert pour développer une proposition dans le cadre du concours visant à projeter le futur Hôpital des Enfants à Genève.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Le groupe Definitely Different a inauguré son nouvel hôtel Peanut Medieval Lodge à St-Ursanne. Niché au sein de la « Perle du Jura », l'hôtel du Bœuf a été intégralement rénové par CCHE avec un projet revisitant les codes de l’univers médiéval.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'La commune de Bussigny poursuit depuis quelques années une croissance régulière et divers quartiers sont en cours de développement avec l’objectif de proposer des lieux de vie de qualité en adéquation avec les besoins de la population.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Située au cœur du développement de l'eco quartier 'Ancienne papeterie' sur le Marly Innovation Center, la nouvelle piscine couverte de Marly, première de Suisse labellisée Minergie-P, a été inaugurée ce jeudi matin.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'La communauté CCHE était réunie jeudi dernier dans le cadre de la rencontre annuelle d’été du bureau. « Les Grillades de l’été », c’est l’occasion pour les collaborateurs.trices de l’ensemble des filiales de découvrir un chantier en cours de réalisation présenté par l’équipe du projet.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Le reportage du MIC dans le magazine Construction et Bâtiment, une édition Espaces Contemporains.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'La rénovation de bâtiment représente un des défis majeurs de la transition énergétique.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      '"Le tout nouvel Hôtel des Horlogers ouvre officiellement ses portes le 2 juin au Brassus. Conçu par Bjarke Ingels Group et réalisé par le bureau suisse CCHE, il s’intègre parfaitement à cette Vallée de Joux, si bien préservée." Prestige Immobilier',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    date: '25.05.2022',
    title:
      'Nouvelle boutique Romain Gauthier dans le centre commercial Takashimaya Nihonbashi à Tokyo',
    content:
      'Conceptualisation d’un aménagement sur mesure pour le nouveau point de vente Romain Gauthier dans le centre commercial Takashimaya Nihonbashi à Tokyo.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'On the occasion of the public opening of the ‘’Hôtel des Horlogers’’ in Brassus, we take a look back at this extraordinary project’s construction site with a presentation by our production teams.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Chaque année, le bureau réunit l’ensemble des collaboratrices.teurs pour découvrir le travail et les projets de leurs collègues au travers de clips diffusés sur grand écran au cinéma.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Le groupe suisse de composants électriques transfère son siège genevois, ses activités de recherche et développement et une unité de production sur le campus technologique 'The Hive' à Meyrin-Satigny.",
    link: 'javascript:void(0)'
  },
  {
    ...
    title: 'MIPIM 2022',
    content:
      "CCHE était présent au MIPIM 2022, le plus grand salon à destination des professionnels de l'immobilier.",
    link: 'javascript:void(0)'
  },
  {
    ...
    date: '17.02.2022',
    title:
      'CCHE termine trois nouvelles transformations et rénovations pour le Crédit Agricole next bank',
    content:
      'Dans la continuité du CANB – Crédit Agricole next bank (Suisse) SA en 2019, CCHE a terminé la rénovation et transformation intérieure de trois agences supplémentaires du Crédit Agricole.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Un travail main dans la main avec le bureau Kengo Kuma pour le développement de la Résidence Etudiante du Grand Morillon, un lieu de vie d’une grande rigueur architecturale et technique.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Dès le départ, le développement du campus The Hive a été appuyé sur une réflexion sociale et environnementale: l'idée principale étant d'aboutir à la mutation d'une zone péri-urbaine en campus technologique à dimension humaine, ancré au coeur d'une forêt.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Ce projet a pu être mené en un temps record grâce à la collaboration pluridisciplinaire et la réactivité des équipes CCHE.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Active au sein du bureau depuis plus d'une année, l'équipe CCHE Digital accompagne les développements du bureau avec des outils innovants à même d'apporter un autre éclairage aux projets et de les porter plus loin.",
    link: 'javascript:void(0)'
  },
  {
    ...
    date: '24.01.2022',
    title:
      'Le bois est de plus en plus utilisé dans les constructions de grande envergure: interview de Matylda Benoist',
    content:
      "L'interview de Matylda Benoist met en lumière l'utilisation croissante du bois dans les constructions de grande envergure, soulignant ses avantages et son impact sur l'architecture contemporaine.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Découvrez l'avancement des différentes étapes du projet de la piscine de Marly à travers des images illustrant le bétonnage du grand plongeoir.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Le bureau CCHE souhaite à tous une excellente année 2022. Visionnez la rétrospective de l'année écoulée, mettant en lumière les moments marquants et les réalisations du bureau.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Explorez le Peanut Mountain Lodge, un hôtel décalé conçu pour les montagnards décontractés. Imaginé par Definitely Different Hôtel Group, il a été entièrement transformé par CCHE pour accueillir un aménagement au design unique et surprenant.',
    link: 'javascript:void(0)'
  },
  {
    ...
    date: '09.12.2021',
    title:
      'CCHE remporte le MEP pour la rénovation du MAMCO avec le bureau berlinois Kuehn Malvezzi',
    content:
      "Le projet lauréat déploie des solutions techniques pour opérer la réorganisation des espaces intérieurs et espaces d’exposition ainsi que l'ajout de grandes ouvertures en façade au niveau de l'entrée en touchant le moins possible ce bâtiment emblématique.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Les travaux pour le collège des Dents du Midi sont officiellement terminés. Cette réalisation marque une étape importante, offrant un nouvel environnement d'apprentissage aux étudiants.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Les nouveaux locaux de l'Office régional de placement (ORP) à Gland, aménagés par l'équipe de CCHE Nyon au sein du bâtiment SEIC, ont été inaugurés. La cérémonie a été présidée par le président de la Confédération Guy Parmelin, en présence de la conseillère d’État Rebecca Ruiz et du conseiller d’État Philippe Leuba.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Perspectives Construction a obtenu la certification EcoEntreprise, marquant une évolution importante et posant les bases d'un modèle d'entreprise et d'une gouvernance en accord avec la philosophie et les valeurs du bureau.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Le bureau CCHE a obtenu le deuxième rang / premier achat avec son projet 'Génération ß' lors du concours d’idée Gaswerkareal Berne, parmi un total de 35 participants. L'idée urbanistique prévoit un quartier dynamique, flexible et écologique, bien intégré à l'espace vert existant et très bien relié à la zone environnante. Elle offre également des typologies innovantes pour répondre aux besoins des générations futures.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "L'équipe de pilotage BIM a obtenu la Certification professionnelle buildingSMART International. Cette certification valide les connaissances liées au BIM d’une manière standardisée et reconnue à l’échelle internationale.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Le magazine Nouvo de la RTS s'intéresse aux constructions en bois, mettant en lumière la tour de 14 étages du projet Malley Phare.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'La Team CCHE a pris le départ pour sa 2e participation à la Runmate, une course de 215 km en relais sur un itinéraire autour du lac Léman.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Parmi les nombreuses candidatures soumises au Prix Bilan de l’Immobilier 2021, trois projets CCHE ont été salués par le jury et occupent une place sur le podium de leurs catégories respectives.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "La SIA met la transformation du bâtiment Incyte à l'honneur, il sera présenté par l'équipe du projet, Marc Fischer, Sara Centeno lors des Visites SIA.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Découvrez une immersion complète sur le chantier The Hive 8, où chaque étape du processus de construction est mise en avant pour une expérience captivante.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Certains de nos projets phares sont mis en lumière grâce à la collaboration avec l'illustrateur Marchettiblink dans le cadre d'une série estivale captivante.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Tous les feux sont au vert pour la surélévation du centre Malley Lumières avec une tour en structure bois de 60 mètres. Le chantier, confié au consortium Perspectives Construction – JPF Ducrest pourra débuter dès janvier 2022.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Promenade avec le Mudac et le 24heures au travers de la ville de Lausanne et de ses bancs publics.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'CCHE a réuni en 2020 des infographes, designer, spécialistes BIM ou designer paramétriques au sein d’un groupe spécialisé CCHE Digital, qui œuvre sur le développement d’outils numériques pour le travail de conception des projets.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Valor Magazine, la revue économique portugaise, s’intéresse au bureau CCHE Porto et donne la parole à son associée Carolina Azevedo pour un éclairage sur les qualités de cette filiale pluridisciplinaire influencée par différentes cultures et sur son évolution.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'La formation se situe au cœur des préoccupations de CCHE et fait partie intégrante des valeurs du bureau.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Développée en 2018, l’entité Perspectives Construction SA complète idéalement la palette de prestations CCHE, en proposant sous la forme de contrats en entreprise générale ou totale, la réalisation de biens immobiliers clé en mains, à des prix et des délais garantis.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Le pavillon implanté au coeur du campus The Hive à Meyrin réunit sous le même toit un restaurant de 200 places avec terrasse, une école de cuisine ouverte à tous et un centre de formation interne.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Bella Vista, complexe Minergie de 288 logements qui redéfinira entièrement l'âme de tout un quartier, est présenté dans la revue Immobilier.ch.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Les halles CFF de Sébeillon, espace industriel atypique, accueillent désormais un espace d’activités sportives et culturelles.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Les évolutions technologiques et l'assouplissement des normes permettent de construire des immeubles de grande taille en bois. Focus sur le projet Malley Phare dans le quotidien Le Temps.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Rencontre avec Anne Devaux, journaliste du quotidien La Côte, pour la visite d'une villa d'exception située sur les rives du lac Léman.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "CCHE est mis à l'honneur par la société de développement et de pilotage de projet Urban Project dans le cadre de la belle collaboration pour le développement du Quartier de l'Etang - îlot A à Vernier.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'CCHE remporte le premier prix du classement du prix Bilan des meilleurs employeurs, catégorie « Immobilier ». Ce résultat salue les mesures et nouveautés RH déployées durant l’année 2020 par le bureau.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Nouveau format d’événement destiné aux collaborateurs du groupe CCHE, My Visit propose de suivre des visites guidées de réalisation en cours en diffusion live streaming.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "290 appartements vont sortir de terre d’ici à 2023 à l'avenue du Vignoble à Neuchâtel et formeront le nouveau quartier Bella Vista.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Développé lors d’un concours international en 2008, ce mobilier urbain a dû s’adapter pour répondre à des contraintes d’utilisation et de sécurité élevée.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Découvrez les dernières avancées sur le chantier du quartier Petite Prairie 2 à Nyon, un projet passionnant en développement.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Découvrez les détails sur le projet du Grand Chemin Nord à Epalinges, où deux bâtiments s'approprient leur espace, dans l'édition du 24 heures.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Découvrez comment les outils de dessin paramétrique permettent d’explorer avec une extrême réactivité les formes idéales dans notre architecture. Présentation d’un escalier hélicoïdal, de la première esquisse à la pose.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Construction d’une piscine scolaire et publique à l’interface entre le Marly Innovation Center et l’éco-quartier de l’Ancienne papeterie.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'CCHE Nyon a intégré depuis de nombreuses années les enjeux liés au développement durable dans ses réflexions et réalisations. Un engagement interne et externe qui vient d’être concrétisé par l’obtention de la certification EcoEntreprise.',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Le MAAP est distingué par un premier prix « Best of Year Awards 2020 » du magazine Interior Design et une nomination au « Dezeen's top 10 museums and galleries of 2020 »",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Le quartier de la Suettaz est actuellement en phase de mise à l'enquête. Découvrez les détails et participez au processus.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'CCHE est au cœur de la mutation du Quartier de l’Etang à Vernier avec le développement de l’îlot « Les Atmosphères », pièce urbaine principale et porte d’entrée du site.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "La nomination de Cornélia Volkringer en tant qu'associée de CCHE Genève SA renforce davantage l'équipe dirigeante de CCHE, reflétant son engagement et sa contribution significative au sein du bureau.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "La restauration du bâtiment historique 'La Maison des fondateurs', connecté à la spirale de verre, constitue un projet emblématique dans le cadre du musée-atelier Audemars Piguet.",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      ' Le plan de quartier Gare Nord-Schenk, entré définitivement en vigueur courant 2020, autorise désormais le lancement du projet de reconversion d’un site industriel en quartier mixte. ',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Le projet lauréat <<Au fil des Saisons>> propose d'implanter l'école au sein d'un parc d’apprentissage regroupant nature et culture dans un environnement proche et innovant",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Le but de cette course, faire le tour du Lac Léman sur un magnifique itinéraire de près de 210km en équipe, entre “mates” et partager des moments inoubliables.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Que l’on traverse le pont des Acacias ou que l’on vienne depuis le quartier de l’Etoile, on aboutira sur l’une des pièces majeures de la future métropole genevoise.',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "CCHE Nyon, première filiale du groupe et exemple de réussite d'un modèle privilégiant la proximité territoriale, poursuit sa croissance et occupe désormais près de 30 collaborateurs.",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Le jury a décerné le 1er prix au projet Ley Outre de CCHE pour le développement d’un site stratégique à l’est de la commune de Crissier',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      ' CCHE se positionne une nouvelle fois sur le podium du prix Bilan des meilleurs employeurs',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Le Musée Atelier Audemars Piguet remporte le 1er prix de la catégorie « Bâtiment public » lors du Prix Bilan de l’Immobilier 2020',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "        Découvrez les aménagements intérieurs et l'atrium de l'ancienne usine Pasta Gala, transformés pour accueillir le nouveau siège d'Incyte",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      '  Le nouveau projet pour la rénovation du 2m2c sera soumis au vote populaire le 27 septembre prochain',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    title: ' CCHE @ Work',
    content:
      ' Certaines de nos habitudes quotidiennes ont été chamboulées, mais le plaisir de collaborer, de célébrer et de se dépasser est toujours aussi présent',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Dedale, la nouvelle gamme de dalles en béton pressé produite par Godelmann et conçue par CCHE design, a remporté le Red Dot Design Award 2020 dans la catégorie "urban design"',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    date: '20.04.2020',
    title:
      ' La dis­tan­cia­tion so­ciale res­pon­sa­bi­lise l’ap­port de tous au tra­vail col­lec­tif',
    content:
  ...
  },
  {
    ...
    content:
      'Les Nyonnais ont plébiscité le plan de quartier par 68,61% d’avis favorables : les 4 îlots d’immeubles de la Suettaz seront construits',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      ' Le Musée Atelier Audemars Piguet, qui réunit la Maison des Fondateurs à une spirale de verre ultra-contemporaine, est prêt à accueillir ses premiers visiteurs dès l’été prochain',
    link: 'javascript:void(0)'
  },
  {
    ...
    title: ' CCHE @ Home',
    content:
      '  Suite à la situation sanitaire actuelle, la grande majorité de nos collaborateurs sont déployés en télétravail afin d’assurer la continuité de notre activité',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'LEM transfère son siège genevois, ses activités de recherche et développement et une unité de production sur le site HIAG « The Hive » à Meyrin (GE)',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Le chantier a commencé pour le premier quartier durable du canton qui prévoit pour sa première phase quelques 400 logements',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'Les équipes pluridisciplinaires investies dans tous les développements CCHE envisagent chaque projet sous un angle transversal pour lui insuffler vision, cohérence et précision',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'L’objectif de ce concours est la construction de l’extension du Tribunal cantonal (TC) à l’Hermitage, afin de réunir les cours sur un seul site',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'CCHE est élu 3e meilleur employeur de la catégorie "Immobilier et Construction" par le magazine Bilan',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Mandat exclusif pour la mise en valeur du Manoir de Haute Roche et la recherche d’acquéreur',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'CCHE lauréat de la pièce A4 au concours qui portait sur les deux dernières pièces urbaines des communaux d’Ambilly à Thônex (GE)',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      'L’ancienne usine Pastagala à Morges a initié sa mue visant à accueillir le siège européen de la société Incyte Biosciences International',
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Une deuxième réalisation pour CCHE sur le site « The Hive » en collaboration avec HIAG',
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "La première pierre du nouvel hôtel des Horlogers d'Audemars Piguet a été posée lundi au Brassus, dans la Vallée de Joux ",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Suite à l’excellente collaboration avec le bureau Kengo Kuma sur le projet ArtLab, nous sommes fiers d’annoncer le démarrage d'une nouvelle aventure commune",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "CCHE a remporté le 1er prix du MEP pour un projet de transformation d'un bâtiment scolaire et d'une salle de gymnastique",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Aujourd'hui a eu lieu l'inauguration du nouveau siège HP Enterprise/HP Inc à Meyrin réalisé par CCHE",
    link: 'javascript:void(0)'
  },
  {
    ...
    content:
      "Nous sommes fiers de vous annoncer que ce projet d'envergure, développé en partenariat avec le bureau Magizan, a été désigné lauréat à l’unanimité du jury",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      "Le bâtiment ArtLab, autrefois connu sous le nom de « Under One Roof », de l'architecte japonais Kengo Kuma, a été inauguré jeudi 3 novembre à l'EPFL",
    link: 'javascript:void(0)'
  },
  {
  ...
  },
  {
    ...
    content:
      'Dans cette zone commerciale très active, nous avions la mission de développer sur une parcelle triangulaire un bâtiment représentatif qui se démarque du reste de la zone commerciale, tout en intégrant un maximum de places de parc.',
    link: 'javascript:void(0)'
  }
]

let actualityData = actualityDatas.map((elt, k) => {
  elt['uid'] = k
  return elt
})
